...
namespace Harrison.Inventory.Data.SqlClient
{
    public class PaymentInfoData:IPaymentInfoData
    {
        ...
        {
            Sql = "Insert into PAYMENT_FORM (INVOICE_ID,VENDOR_ID,PAID_DATE,TO_PAY,FROM_HO,OTHER_DEBITS,PAYMENT_METHOD,TOTAL_PAID,BALANCE,REMARKS) values( '" + paymentinfo.INVOICE_ID.ToString() + "','" + paymentinfo.VENDOR_ID.ToString() + "','" + paymentinfo.PAID_DATE + "'," +paymentinfo.TO_PAY.ToString()+ "," + paymentinfo.FROM_HO.ToString() + "," + paymentinfo.OTHER_DEBITS.ToString() + ",'" + paymentinfo.PAYMENT_METHOD.ToUpper() + "'," + paymentinfo.TOTAL_PAID.ToString() + "," + paymentinfo.BALANCE.ToString() + ",'" +paymentinfo.REMARKS.ToUpper() +"')";
        ...
        {
            Sql = "UPDATE PAYMENT_FORM set VENDOR_ID='" + paymentinfo.VENDOR_ID.ToString() + "',PAID_DATE='" + paymentinfo.PAID_DATE + "',TO_PAY=" + paymentinfo.TO_PAY.ToString() + ",FROM_HO=" + paymentinfo.FROM_HO.ToString() + ",OTHER_DEBITS=" + paymentinfo.OTHER_DEBITS.ToString() + ",PAYMENT_METHOD='" + paymentinfo.PAYMENT_METHOD.ToUpper() + "',TOTAL_PAID=" + paymentinfo.TOTAL_PAID.ToString() + ",BALANCE=" + paymentinfo.BALANCE.ToString() + ",REMARKS='" + paymentinfo.REMARKS.ToUpper() + "' WHERE INVOICE_ID="+paymentinfo.INVOICE_ID.ToString();
