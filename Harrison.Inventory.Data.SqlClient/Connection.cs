...
namespace Harrison.Inventory.Data.SqlClient
{
    public class DBConnection
    {
        public DataTable Sqlconnection(String sql, String TypeExec)
        {
            ...
            connetionString = "Data Source=(local);Initial Catalog=HML_PURCHASE;User ID=Joyce;Password=hmlpurchase";
            ...
            try
            {
                ...
                else if (TypeExec == "Insert"||TypeExec=="Delete"||TypeExec=="Update")
                {
