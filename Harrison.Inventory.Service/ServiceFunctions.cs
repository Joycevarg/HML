...
namespace Harrison.Inventory.Service
{
    public class ServiceFunctions : IServicefunctions
    {
        ...
        public int VendorReportHeader(Excel._Worksheet worksheet,int vendorid)
        {
            ...
            worksheet.Shapes.AddPicture("C:\\Users\\Joyce Varghese\\Documents\\hml'\\HML1\\hmllogo.jpg", Microsoft.Office.Core.MsoTriState.msoFalse, Microsoft.Office.Core.MsoTriState.msoCTrue, 160, 12, 45, 45); 
            for(int i=1;i<9;i++)
